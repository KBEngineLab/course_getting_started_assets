...
namespace KBEngine
{
	...
	public class EntityDef
	{
		...
		public static void initScriptModules()
		{
			...
			KBVector3 FirstEntity_position_defval = new KBVector3();
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(FirstEntity), property(position / 40000).");
			...
			KBVector3 FirstEntity_direction_defval = new KBVector3();
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(FirstEntity), property(direction / 40001).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(FirstEntity), property(spaceID / 40002).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(FirstEntity), method(onEnter / 3).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(FirstEntity), method(onSay / 4).");

			List<DATATYPE_BASE> pFirstEntity_helloBase_args = new List<DATATYPE_BASE>();
			pFirstEntity_helloBase_args.Add(EntityDef.id2datatypes[12]);

			Method pFirstEntity_helloBase = new Method();
			pFirstEntity_helloBase.name = "helloBase";
			pFirstEntity_helloBase.methodUtype = 2;
			pFirstEntity_helloBase.aliasID = -1;
			pFirstEntity_helloBase.args = pFirstEntity_helloBase_args;

			pFirstEntityModule.methods["helloBase"] = pFirstEntity_helloBase; 
			pFirstEntityModule.base_methods["helloBase"] = pFirstEntity_helloBase;

			pFirstEntityModule.idbase_methods[pFirstEntity_helloBase.methodUtype] = pFirstEntity_helloBase;

			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(FirstEntity), method(helloBase / 2).");
			...
			//KBELog.DEBUG_MSG("EntityDef::initScriptModules: add(FirstEntity), method(say / 1).");
